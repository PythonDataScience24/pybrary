...
class LibraryGUI:
    ...
    def setup_tab1(self):
        ...
        # Make it so only input fields stretch
        self.tab1.set_column_weights(0,1,0,1)

        # Add input fields to tab1
        self.tab1.add(self.title_lbl, 1, 1)
        self.tab1.add(self.title_inp, 1, 2, fill=True, stretch=True)
        self.tab1.add(self.author_lbl, 1, 3)
        self.tab1.add(self.author_inp, 1, 4, fill=True, stretch=True)
        self.tab1.add(self.year_lbl, 2, 1)
        self.tab1.add(self.year_inp, 2, 2, fill=True, stretch=True)
        self.tab1.add(self.genre_lbl, 2, 3)
        self.tab1.add(self.genre_inp, 2, 4, fill=True, stretch=True)
        self.tab1.add(self.pages_lbl, 3, 1)
        self.tab1.add(self.pages_inp, 3, 2, fill=True, stretch=True)
        self.tab1.add(self.rating_lbl, 3, 3)
        self.tab1.add(self.rating_inp, 3, 4, fill=True, stretch=True)
        self.tab1.add(self.synopsis_container, 4, 1, column_span=4, fill=True, stretch=True)
        self.tab1.add(self.button_container, 5, 1, column_span=4, fill=True, stretch=True)
        self.synopsis_container.add(self.synopsis_inp, 1, 1, fill=True, stretch=True)
